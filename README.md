...
To build you need a local repo of cm 13, aicp-mm or resurrection remix mm and a proper device tree. To see how a buildable  device tree looks check [this one from my github](https://github.com/carliv/device_mlais_mx).
